        ...
        <div className="max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-zinc-200/60 bg-white/70 p-4 shadow-sm backdrop-blur border-l-4 border-l-brand-500">
              ...
              <p className="text-xl font-bold text-zinc-900">98% inbox rate</p>
              <p className="text-sm text-zinc-500">Expect 98% inbox rates when we migrate and lock in SPF/DKIM.</p>
            </div>
            <div className="rounded-2xl border border-zinc-200/60 bg-white/70 p-4 shadow-sm backdrop-blur border-l-4 border-l-success-500">
              ...
              <p className="text-xl font-bold text-zinc-900">2.3s → 0.6s</p>
            ...
            <div className="rounded-2xl border border-zinc-200/60 bg-white/70 p-4 shadow-sm backdrop-blur border-l-4 border-l-accent-500">
              ...
              <p className="text-xl font-bold text-zinc-900">3.5× pipeline</p>
              <p className="text-sm text-zinc-500">Expect 3.5× pipeline when follow-up automations click into place.</p>
            </div>
          </div>
        </div>
